    ...
    */
    ...
    while (alarmCount < 3)
    {
        ...
        if (alarmEnabled == FALSE)
        {
            ...
            bytes = read(fd, buffer_received, BUF_SIZE);
            ...
            if ((buffer_received[0] == 0x7E) && (buffer_received[1] == 0x01) && (buffer_received[2] == 0x07) && (buffer_received[3] == 6) && (buffer_received[4] == 0x7E)){
                alarm(0);
                printf("parou\n");
                break;
            }
    ...
    //buffer_send[bytes] = '\0'; // Set end of string to '\0', so we can printf
